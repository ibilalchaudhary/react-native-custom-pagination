...
_Most Common Component Prefix Options_:`dot`, `startDot`,`endDot`
_Most Common Component Body Options_:`Icon`, `Font`,`Style` ,`Color`
_Most Common Component Suffix Options_:`Hide`, `Size`,`IconFamily` ,or `NotActive`,`Active` `Empty`
